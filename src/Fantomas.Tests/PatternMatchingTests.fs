...
let ``vanity alignment used when splitting line in match block, 1901`` () =
    formatSourceString
        false
        """
match Caching.Instance.TryRetrieveLastCompoundBalanceLoooooooooooooooooooooooooooooooooooooooonnnnngFuncName address currency with
| None -> false
| Some balance -> someRetrievedBalance = balance"""
    ...
    |> should
        ...
        """
match
    Caching.Instance.TryRetrieveLastCompoundBalanceLoooooooooooooooooooooooooooooooooooooooonnnnngFuncName
        address
        currency with
| None -> false
| Some balance -> someRetrievedBalance = balance
